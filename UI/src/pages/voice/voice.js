...
import "../../pages/voice/voice.css";
import alanBtn from "@alan-ai/alan-sdk-web";
// let alanKey = "67254c6d750a036c9a01ac6ae831c3202e956eca572e1d8b807a3e2338fdd0dc/stage
let alanKey =
  "db9b041a47410bce724c4b7120dbebd92e956eca572e1d8b807a3e2338fdd0dc/stage";
  ...
  function onSearchSubmit(term) {
    ...
    try {
      fetch(url, {
        ...
        .then((data) => {
          let main_data = data["data"]["response"];
          setOrganic1(main_data);
          setOrganic1Link(data["data"]["link"]);
    ...
    <>
      ...
      <section className="textbox">
        <div className="grid place-items-center">
          <div className="textbox container bg-gray-100 p-10  mt-4 text-center">
            <p className="text-2xl font-medium text-green-600 my-4 text-center">
            ...
            <div className="my-10 p-6 bg-gray-300 bg-opacity-30 border border-gray-900 border-opacity-10">
              ...
              <div className="flex flex-row place-content-end">
                <p className="text-xs font-medium text-green-600">
                  <a href={organic1Link} target="_blank">Read More</a>
                </p>
              </div>
            </div>
